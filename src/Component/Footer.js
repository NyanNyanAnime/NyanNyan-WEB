...
const Footer = () => {
    return (
        <>
            <footer className="bgColorPrimary3 shadow-inner dark:bg-gray-900 py-10">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-10 sm:gap-40">
                    <div className='flex flex-col items-center justify-center'>
                        <a href='/'><img src={Logo} alt='Logo' className='w-40 duration-300 hover:scale-110' /></a>
                        <span className='sm:text-xl pt-4 font-light text-gray-500 text-center '>
