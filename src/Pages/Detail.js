...
const Detail = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            try {
                const res = await axios.get(`https://animanga.aninyan.com/anime/details/${animeId}`);
                ...
                if (batchEpisode) {
                    const batchRes = await axios.get(`https://animanga.aninyan.com/anime/batch/${batchEpisode.episode_id}`);
